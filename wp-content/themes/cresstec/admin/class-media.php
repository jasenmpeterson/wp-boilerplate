...
use Cresstec\Helpers as General_Helpers;
      ...
      try {
        ...
        if ( file_exists( $path ) ) {
          ...
          if ( ! $this->general_helper->is_valid_xml( $svg_content ) ) {
            new \WP_Error( sprintf( esc_html__( 'Error: File invalid: %s', 'cresstec' ), $path ) );
            return false;
          }
        ...
        new \WP_Error( sprintf( esc_html__( 'Error: %s', 'cresstec' ), $e ) );
      }
    }
