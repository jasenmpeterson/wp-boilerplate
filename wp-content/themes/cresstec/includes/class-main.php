 ...
 *
 * @since   2.0.0
 * @package Cresstec\Includes
 */

namespace Cresstec\Includes;

use Cresstec\Admin as Admin;
use Cresstec\Admin\Menu as Menu;
use Cresstec\Plugins\Acf as Acf;
use Cresstec\Theme as Theme;
...
class Main {
  ...
  public function __construct() {
    ...
    if ( defined( 'CRESS_THEME_VERSION' ) ) {
      $this->theme_version = CRESS_THEME_VERSION;
    } else {
      $this->theme_version = '1.0.0';
    }

    if ( defined( 'CRESS_THEME_NAME' ) ) {
      $this->theme_name = CRESS_THEME_NAME;
    } else {
      $this->theme_name = 'cresstec';
    }
